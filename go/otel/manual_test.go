...
func TestWriteOverrideSchema(t *testing.T) {
	...
	wireSchema = schem.ToWireForRoot("Metrics")

	//// Remove "Monotonic" field (field #8) from "Metric" struct in the schema.
	//wireSchema.StructFieldCount["Metric"] = 7
	//
	//// Remove "Float64" field (field #2) from "PointValue" oneof struct in the schema.
	//wireSchema.StructFieldCount["PointValue"] = 1
	//
	...
	//delete(wireSchema.StructFieldCount, "HistogramValue")
	//delete(wireSchema.StructFieldCount, "ExpHistogramValue")
