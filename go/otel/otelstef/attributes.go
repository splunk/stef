...
func (m *Attributes) canBeShared() bool {
...
// specified schema.
func (m *Attributes) mutateRandom(random *rand.Rand, schem *schema.Schema, limiter *mutateRandomLimiter) {
	if random.IntN(20) == 0 {
