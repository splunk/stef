...
//  6. Starts a background goroutine to receive messages from the server. This will results in
...
//
// Returns:
//   - ChunkWriter: A STEF Writer can be created over chunk writer to STEF data over gRPC connection.
