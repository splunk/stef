    ...
    void testSpansWriteRead() {
        ...
        for (WriterOptions opt : opts) {
            try {
                ...
                SpansWriter writer = new SpansWriter(buf, opt);
