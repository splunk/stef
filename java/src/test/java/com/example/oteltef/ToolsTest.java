...
public class ToolsTest {
    ...
    private void diffData(String rootStruct, String fname1, String fname2) throws Exception {
        ...
        try (FileInputStream file1 = new FileInputStream(fname1);
            ...
            case "Spans": {
                SpansReader reader1 = new SpansReader(file1);
                SpansReader reader2 = new SpansReader(file2);
            ...
            case "Metrics": {
                MetricsReader reader1 = new MetricsReader(file1);
                MetricsReader reader2 = new MetricsReader(file2);
    ...
    private void copyData(String rootStruct, String fname1, String fname2) throws Exception {
        ...
        try (FileInputStream sourceFile = new FileInputStream(fname1);
            ...
            case "Spans": {
                SpansReader reader = new SpansReader(sourceFile);
                SpansWriter writer = new SpansWriter(new WrapChunkWriter(destFile), WriterOptions.builder().build());
            ...
            case "Metrics": {
                MetricsReader reader = new MetricsReader(sourceFile);
                MetricsWriter writer = new MetricsWriter(new WrapChunkWriter(destFile), WriterOptions.builder().build());
    ...
    private void generateData(String rootStruct, String outFileName, long seed, long recordCount) throws Exception {
        ...
        try (FileOutputStream outFile = new FileOutputStream(outFileName)) {
            ...
            case "Spans": {
                SpansWriter writer = new SpansWriter(new WrapChunkWriter(outFile), WriterOptions.builder().build());
            ...
            case "Metrics": {
                MetricsWriter writer = new MetricsWriter(new WrapChunkWriter(outFile), WriterOptions.builder().build());
