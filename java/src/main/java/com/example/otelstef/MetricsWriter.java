...
// MetricsWriter allows writing records of Metrics
...
public class MetricsWriter {
    ...
    private MetricsEncoder encoder;
    private WriterState state;
    private WriteBufs writeBufs;
    private long frameRecordCount;
    private long recordCount;

    public MetricsWriter(ChunkWriter dst, WriterOptions opts) throws IOException {
        this.dst = dst;
        this.opts = opts;
        this.record = new Metrics();
        this.state = new WriterState();
        this.encoder = new MetricsEncoder();
