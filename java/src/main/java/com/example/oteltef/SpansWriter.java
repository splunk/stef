...
// SpansWriter allows writing records of Spans
...
public class SpansWriter {
    ...
    private SpansEncoder encoder;
    private WriterState state;
    private WriteBufs writeBufs;
    private long frameRecordCount;
    private long recordCount;

    public SpansWriter(ChunkWriter dst, WriterOptions opts) throws IOException {
        this.dst = dst;
        this.opts = opts;
        this.record = new Spans();
        this.state = new WriterState();
        this.encoder = new SpansEncoder();
