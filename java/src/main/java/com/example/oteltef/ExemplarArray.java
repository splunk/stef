...
public class ExemplarArray {
    ...
    boolean markDiffModified(ExemplarArray v) {
    ...
    public void copyFrom(ExemplarArray src) {
        ...
        if (minLen < elemsLen) {
            ...
            for (int j=0; j < addLen; j++) {
                // Init the element.
                elems[i+j] = new Exemplar(parentModifiedFields, parentModifiedBit);
                // Copy the element.
    ...
    void ensureElems(int newLen) {
        if (elems.length < newLen) {
            ...
            Exemplar[] newElems = new Exemplar[allocLen];
    ...
    public boolean equals(ExemplarArray val) {
