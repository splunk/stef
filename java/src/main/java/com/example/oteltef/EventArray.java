...
public class EventArray {
    ...
    void ensureElemsSize(int newSize) {
        if (elems.length < newSize) {
            ...
            Event[] newElems = new Event[newSize];
    ...
    public static void copyEventArray(EventArray dst, EventArray src) {
        ...
        if src.elems.length>0 {
            ...
            elems := make([]Event, src.elems.length)
    ...
    public boolean isEqual(EventArray val) {
        if (size != val.size) {
            return false;
        }
