...
public class SpansReader {
    ...
    private final SpansDecoder decoder = new SpansDecoder();
    ...
    private final Spans record = new Spans();

    public SpansReader(InputStream source) throws IOException {
        base = new BaseReader(new BufferedInputStream(source, 64 * 1024));
        initSchema();
    }

    private void initSchema() throws IOException {
        WireSchema ownSchema = Spans.wireSchema();
    ...
    public ReadResult read(ReadOptions opts) throws IOException {
