...
// Encoder for Int64Array
class Int64ArrayEncoder {
    private final BitsWriter buf = new BitsWriter();
    private SizeLimiter limiter;
    private Int64Encoder elemEncoder;
    ...
    public void encode(Int64Array arr) throws IOException {
