...
class QuantileValueDecoder {
    ...
    private Float64Decoder quantileDecoder = new Float64Decoder();
    private Float64Decoder valueDecoder = new Float64Decoder();
    ...
    public void continueDecoding() {
        ...
        this.quantileDecoder.continueDecoding();
        if (this.fieldCount <= 1) {
            return; // Value and subsequent fields are skipped.
        }
