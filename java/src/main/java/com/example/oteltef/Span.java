...
public class Span {
    ...
    public static final String SpanStructName = "Span";
    ...
    public boolean isEqual(Span val) {
        ...
        if (!this.events.isEqual(val.events)) {
            return false;
        }
        if (!this.links.isEqual(val.links)) {
            return false;
        }
        if (!this.status.isEqual(val.status)) {
            return false;
        }
        return true;
    }

    public static boolean SpanEqual(Span left, Span right) {
