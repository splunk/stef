...
// pairs from StringValue to byte[].
public class EnvelopeAttributes {
    ...
    EnvelopeAttributes(ModifiedFields parentModifiedFields, long parentModifiedBit) {
    ...
    public EnvelopeAttributes clone() {
        EnvelopeAttributes clone = new EnvelopeAttributes();
        copyEnvelopeAttributes(clone, this);
        return clone;
    }
    ...
    boolean isSameKeys(EnvelopeAttributes val2) {
