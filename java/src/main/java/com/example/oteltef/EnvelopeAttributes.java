...
// pairs from StringValue to BytesValue.
public class EnvelopeAttributes {
    ...
    public void append(StringValue k, BytesValue v) {
    ...
    public boolean equals(EnvelopeAttributes val) {
