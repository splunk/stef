module github.com/tigrannajaryan/stef/otelcol

go 1.23.2

require (
	github.com/spf13/pflag v1.0.5 // indirect
	github.com/tigrannajaryan/stef/stef-gogrpc v0.0.0
...
// pin version until https://github.com/tigrannajaryan/stefcol/pull/2418 is resolved
replace github.com/testcontainers/testcontainers-go => github.com/testcontainers/testcontainers-go v0.15.0

replace (
	github.com/tigrannajaryan/stef/stef-go => ../stef-go
	github.com/tigrannajaryan/stef/stef-gogrpc => ../stef-gogrpc
	github.com/tigrannajaryan/stef/stef-otel => ../stef-otel
	github.com/tigrannajaryan/stef/stef-pdata => ../stef-pdata
)
