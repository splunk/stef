...
func NewSampleReader(source io.Reader) (*SampleReader, error) {
...
func (r *SampleReader) initSchema() error {
...
func (f *SampleReader) Header() *pkg.FixedHeader {
	return &f.base.FixedHeader
}

func (f *SampleReader) UserData() map[string]string {
	return f.base.VarHeader.UserData
}

// Read the next record. After Read() returns successfully the record
// will be accessible in SampleReader.Record field.
//
...
func (r *SampleReader) Read(opts pkg.ReadOptions) error {
...
func (r *SampleReader) RecordCount() uint64 {
	return r.base.RecordCount
}

func (r *SampleReader) nextFrame() error {
